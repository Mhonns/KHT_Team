...
with open('complete_hospital_data_p1.csv', 'w', newline='', encoding='utf-8') as csv_file:
    ...
    writer.writerow(["hospital_name", "province", "district", "sub_district", "postal_code", "formatted_address", "gps_latitude", "gps_longitude"])
    ...
    for item in data:
        ...
        hospital_name = address_components[0]
